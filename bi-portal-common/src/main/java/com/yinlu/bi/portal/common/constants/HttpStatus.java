package com.yinlu.bi.portal.common.constants;
...
public interface HttpStatus {
  ...
  /**
   * Static constant for a 418 error. {@code 418 Unprocessable Entity} (WebDAV drafts?) or {@code
   * 418 Reauthentication Required} (HTTP/1.1 drafts?)
   */
  // not used
